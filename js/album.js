/* ============================================================
   ÁLBUM PARA COMPARTIR — XV Años Denisse Yamilet Gómez Gutiérrez

   album.html?filtro=album        → solo el álbum digital
   album.html?filtro=impresion    → solo las fotos de impresión
   album.html?filtro=ampliacion   → solo la(s) ampliación(es)
...
const TITULOS = {
    ...
    ampliacion: { titulo: 'La ampliación',        sub: 'La foto grande de exhibición ' + CFG.paquete.ampliacionMedida },
...
async function iniciar() {
    ...
    try {
        ...
        try { selecciones = JSON.parse(localStorage.getItem('denisse_selecciones') || '{}'); }
