...
(function () {
    ...
    const KEY_VISTA = 'denisse_ayuda_vista';
    ...
    const EXTRAS = [
        {
            ...
            ayuda: 'Los botones <em>Todas · Impresión · Ampliación · Álbum Digital · Descartadas · Sin Clasificar</em> cambian qué fotos ves. ' +
        ...
        },
        {
            ...
            ayuda: '<strong>← →</strong> cambian de foto · <strong>Enter</strong> guarda y cierra · <strong>Esc</strong> cierra sin guardar · <strong>1, 2, 3, 4</strong> marcan o desmarcan Impresión, Ampliación, Álbum y Descartar.'
        },
        {
            icono: '⬇️',
    ...
    function construirHTML() {
        ...
        secciones += '<h4 class="ayuda-grupo">Las 4 herramientas de tu selector</h4>';
        TOOLS.forEach(t => {
